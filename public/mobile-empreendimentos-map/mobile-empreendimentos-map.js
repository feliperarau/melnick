...
/* harmony import */ var _nav_overlay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../nav-overlay */ "./components/nav-overlay/index.js");
...
var header = function header() {
  ...
  var toggleScroll = function toggleScroll(e, header) {
    if (window.scrollY > 0) {
...
/***/ "./components/real-estate-filters/collapse.js":
/*!****************************************************!*\
  !*** ./components/real-estate-filters/collapse.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./components/real-estate-filters/index.js":
/*!*************************************************!*\
  !*** ./components/real-estate-filters/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "realEstateFilters": () => (/* binding */ realEstateFilters)
/* harmony export */ });
/* harmony import */ var bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js");
...
/* harmony import */ var _collapse__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./collapse */ "./components/real-estate-filters/collapse.js");




var realEstateFilters = function realEstateFilters() {
  var ref = document.querySelectorAll("._real-estate-filters");
  /**
   * Handle the filter clear action
   * @param {*} dropdown
   */

  var clearFilters = function clearFilters(dropdown) {
    var toggler = dropdown.querySelector(".dropdown-toggle");
    var checkboxes = dropdown.querySelectorAll("._checkbox");
    var togglerLabel = toggler.querySelector("span");
    var temporaryLabel = toggler.querySelector(".temporary-label");
    checkboxes.forEach(function (checkbox) {
      var input = checkbox.querySelector("input");
      input.checked = false;
    });
    var dropdownIns = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Dropdown(toggler);
    dropdownIns.toggle();
    togglerLabel === null || togglerLabel === void 0 ? void 0 : togglerLabel.classList.remove("d-none");
    temporaryLabel === null || temporaryLabel === void 0 ? void 0 : temporaryLabel.remove();
  ...
  var saveFilters = function saveFilters(dropdown) {
    var _toggler$querySelecto, _firstSelection$paren;

    var toggler = dropdown.querySelector(".dropdown-toggle");
    var togglerLabel = toggler.querySelector("span");
    var selected = dropdown.querySelectorAll("input[type=checkbox]:checked");
    var dropdownIns = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Dropdown(toggler);
    dropdownIns.toggle();
    ...
    var temporaryLabel = (_toggler$querySelecto = toggler.querySelector(".temporary-label")) === null || _toggler$querySelecto === void 0 ? void 0 : _toggler$querySelecto.remove();
    var firstSelection = selected[0];
    var firstSelectionLabel = (_firstSelection$paren = firstSelection.parentElement.querySelector(".label")) === null || _firstSelection$paren === void 0 ? void 0 : _firstSelection$paren.textContent;

    if (selected.length > 1) {
      firstSelectionLabel = "".concat(firstSelectionLabel, " +").concat(selected.length - 1);
    }
  ...
  var cleanModalFilters = function cleanModalFilters(modal) {
    var radios = modal.querySelectorAll('input[type="radio"]:checked');
    var sliders = modal.querySelectorAll(".slider");
  ...
  ref.forEach(function (component) {
    var dropdowns = component.querySelectorAll(".dropdown");
    var modal = component.querySelector(".modal");
    var sliders = modal.querySelectorAll(".slider");
    var modalClean = modal.querySelector(".bottom .clear");
    var rows = modal.querySelectorAll(".filter-row");
    rows.forEach(function (row) {
      var toggler = row.querySelector(".left");
      var target = row.querySelector(".right");
      var bsCollapse = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Collapse(target, {
        toggle: false
      });
      toggler.addEventListener("click", function (e) {
        console.log(e);
    ...
    modalClean.addEventListener("click", function () {
      return cleanModalFilters(modal);
    });
    sliders.forEach(function (slider) {
      var controls = slider.parentElement.querySelector(".slider-controls");
...
var __webpack_exports__ = {};
/*!*****************************************************!*\
  !*** ./pages/mobile-empreendimentos-map/scripts.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mobileEmpreendimentosMap": () => (/* binding */ mobileEmpreendimentosMap)
/* harmony export */ });
...
/* harmony import */ var _components_entry_real_estate_list__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/entry-real-estate-list */ "./components/entry-real-estate-list/index.js");
/* harmony import */ var _components_real_estate_filters__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/real-estate-filters */ "./components/real-estate-filters/index.js");
// Assets
 // Components
...
var mobileEmpreendimentosMap = function mobileEmpreendimentosMap() {//console.log("");
};
mobileEmpreendimentosMap();
})();
...
"use strict";
/*!******************************************************!*\
  !*** ./pages/mobile-empreendimentos-map/styles.scss ***!
  \******************************************************/
__webpack_require__.r(__webpack_exports__);
// extracted by mini-css-extract-plugin
