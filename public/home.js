...
var select = function select() {
  var ref = document.querySelectorAll("._select");

  var handleToggle = function handleToggle(toggler, target, container) {
    var label = toggler.querySelector(".label");
  ...
  ref.forEach(function (component) {
    var toggler = component.querySelector(".toggler");
    var selected = component.querySelector(".option.selected");
    var optionsContainer = component.querySelector(".options-container");
    var optionsList = component.querySelectorAll(".option");
...
/***/ "./components/carousel-real-estate/index.js":
/*!**************************************************!*\
  !*** ./components/carousel-real-estate/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "carouselRealEstate": () => (/* binding */ carouselRealEstate)
/* harmony export */ });
...
var carouselRealEstate = function carouselRealEstate() {
  var ref = document.querySelectorAll("._carousel-real-estate");
  if (!ref.length) return; // For every component on the page...

  for (var c = 0; c < ref.length; c++) {
    var component = ref[c];
    var sliderContainer = component.querySelectorAll(".swiper");
...
/***/ "./components/entry-real-estate/index.js":
/*!***********************************************!*\
  !*** ./components/entry-real-estate/index.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var entryRealEstate = function entryRealEstate() {
  var ref = document.querySelectorAll("._entry-real-estate");
  if (!ref.length) return; // For every component on the page...
...
entryRealEstate();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (entryRealEstate);

/***/ }),

/***/ "./components/header-alt/index.js":
/*!****************************************!*\
  !*** ./components/header-alt/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./components/hero-details/index.js":
/*!******************************************!*\
  !*** ./components/hero-details/index.js ***!
  \******************************************/
/***/ (() => {
...
/***/ "./components/hero-search/index.js":
/*!*****************************************!*\
  !*** ./components/hero-search/index.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_js_modules_select_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../assets/js/modules/select.js */ "./assets/js/modules/select.js");
...
/* harmony export */ });
/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/bundle */ "./node_modules/swiper/swiper-bundle.esm.js");
/* harmony import */ var _hero_search___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hero-search/ */ "./components/hero-search/index.js");
/* harmony import */ var _hero_details___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../hero-details/ */ "./components/hero-details/index.js");
/* harmony import */ var _hero_details___WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_hero_details___WEBPACK_IMPORTED_MODULE_2__);
// Modules
 //Components
...
var hero = function hero() {
  var ref = document.querySelectorAll("._hero");
  if (!ref.length) return; // For every component on the page...

  for (var c = 0; c < ref.length; c++) {
    var component = ref[c];
    var sliderContainer = component.querySelector(".slider");
    var sliderPagination = component.querySelector(".swiper-pagination");
    var swiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](sliderContainer, {
      pagination: {
        el: sliderPagination,
        clickable: true
      }
