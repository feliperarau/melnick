...
;// CONCATENATED MODULE: ./components/header-alt/index.js
...
headerAlt();
/* harmony default export */ const header_alt = ((/* unused pure expression or super */ null && (headerAlt)));
...
;// CONCATENATED MODULE: ./assets/js/modules/select.js
...
select_select();
;// CONCATENATED MODULE: ./components/hero-search/index.js
...
var hero = function hero() {
  ...
  for (var c = 0; c < ref.length; c++) {
    ...
    var swiper = new core(sliderContainer, {
      pagination: {
        el: sliderPagination,
        clickable: true
      }
...
hero();
/* harmony default export */ const components_hero = ((/* unused pure expression or super */ null && (hero)));
;// CONCATENATED MODULE: ./components/entry-real-estate/index.js
...
entryRealEstate();
/* harmony default export */ const entry_real_estate = ((/* unused pure expression or super */ null && (entryRealEstate)));
;// CONCATENATED MODULE: ./components/carousel-real-estate/index.js
// Modules
 //Components
...
carouselRealEstate();
/* harmony default export */ const carousel_real_estate = ((/* unused pure expression or super */ null && (carouselRealEstate)));
;// CONCATENATED MODULE: ./pages/home/scripts.js
// Assets
 // Components
...
home();
/* harmony default export */ const scripts = ((/* unused pure expression or super */ null && (home)));
})();
